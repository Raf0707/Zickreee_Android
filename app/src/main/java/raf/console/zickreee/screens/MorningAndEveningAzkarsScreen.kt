...
@Composable
fun MorningAndEveningAzkarsScreen(context: Context) {
    val duas = remember { loadDuasFromAssets(context, "morning_and_evening_azkars.json") }
    ...
    LazyColumn (
        ...
        item {
            Text(
                text = "Утренние и вечерние азкары",
