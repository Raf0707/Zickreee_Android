...
@Composable
fun DuaIsmulAzamScreen(context: Context) {
    val duas = remember { loadDuasFromAssets(context, "dua_ismul_azam.json") }
    ...
    LazyColumn (
        ...
        item {
            Text(
                text = "Дуа, в которых упомянуто Величайшее имя Всевышнего Аллаха",
